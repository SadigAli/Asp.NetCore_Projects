        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkGraphic = table.Column<string>(maxLength: 50, nullable: false),
                    WebPage = table.Column<string>(maxLength: 100, nullable: false),
                    Address = table.Column<string>(maxLength: 100, nullable: true),
                    FacebookLink = table.Column<string>(maxLength: 100, nullable: true),
                    TwitterLink = table.Column<string>(maxLength: 100, nullable: true),
                    PinterestLink = table.Column<string>(maxLength: 100, nullable: true),
                    GoogleLink = table.Column<string>(maxLength: 100, nullable: true),
                    SkypeLink = table.Column<string>(maxLength: 100, nullable: true),
                    HeaderLogo = table.Column<string>(maxLength: 100, nullable: true),
                    FooterLogo = table.Column<string>(maxLength: 100, nullable: true),
                    FooterAbout = table.Column<string>(maxLength: 200, nullable: false),
                    ContactInfo = table.Column<string>(maxLength: 200, nullable: false),
                    AboutUs = table.Column<string>(maxLength: 1000, nullable: false),
                    AboutTitle = table.Column<string>(maxLength: 100, nullable: true),
                    Copyright = table.Column<string>(maxLength: 150, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SosialIcons", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SosialIconId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
